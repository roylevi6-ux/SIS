...
MODEL_AGENT_10 = _get_model("agent_10", "anthropic/claude-sonnet-4-20250514")
    ...
    return {
        ...
        "new_logo": {
            ...
            "synthesis_agent_10": {
                ...
                "champion_absence_health_ceiling": 65,
        ...
        "expansion": {
            ...
            "synthesis_agent_10": {
                "health_score_weights": {
                    "account_relationship_health": 13,

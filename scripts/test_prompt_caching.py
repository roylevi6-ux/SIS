...
def build_large_system_prefix() -> str:
    ...
    stage_block = (
        "## Stage Definitions\n\n"
        "### Stage 1 - Qualify\n"
        "AE dives deeper after BD handoff — refine use case, validate fit, identify "
        "decision drivers, validate contacts. Key signals: use case discussion, "
        "market/vertical fit, NDA mentions, BD-to-AE handoff. "
        "Exit criteria: Challenges refined, products identified, decision drivers understood.\n\n"
        "### Stage 2 - Establish Business Case\n"
        "Build ROI framework, CPQ configuration. Key signals: data exports, "
        "order volume analysis, chargeback rate discussion, ROI calculations. "
        "Exit criteria: Business case documented with measurable value.\n\n"
        "### Stage 3 - Scope\n"
        "Refine value proposition, demonstrate technology advantages, draft quote, "
        "run pilots. Key signals: pricing proposals, POC results, fee structures, "
        "pilot discussions. "
        "Exit criteria: Value quantified, pilot results reviewed, quote drafted.\n\n"
        "### Stage 4 - Proposal\n"
        "Build pricing matrix, secure internal approvals, send formal proposal. "
        "Key signals: multi-department meetings, budget discussions, executive "
        "escalations, internal buy-in. Exit criteria: Proposal delivered, pricing approved.\n\n"
        "### Stage 5 - Negotiate\n"
        "Revise pricing/terms, secure written commitment, draft contract. Key signals: "
        "contract terms, SLA discussions, redlines, procurement engagement. "
        "Exit criteria: Terms agreed, contract drafted.\n\n"
        "### Stage 6 - Contract\n"
        "Finalize redlines, obtain signatures, begin implementation planning. "
        "May overlap with Stage 7. Key signals: MSA execution, legal sign-off. "
        "Exit criteria: Contract signed.\n\n"
        "### Stage 7 - Implement\n"
        "Technical integration, CW checklist, go-live. Key signals: API setup, "
        "sandbox testing, data mapping, approval rate tuning, production traffic. "
        "Exit criteria: System integrated, go-live complete = Closed Won.\n\n"
    )
